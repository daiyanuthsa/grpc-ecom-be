...
const (
	...
	ProductService_ListProductsAdmin_FullMethodName = "/product.ProductService/ListProductsAdmin"
)
...
type ProductServiceClient interface {
	...
	ListProductsAdmin(ctx context.Context, in *ListProductsAdminRequest, opts ...grpc.CallOption) (*ListProductsAdminResponse, error)
}
...
func (c *productServiceClient) ListProductsAdmin(ctx context.Context, in *ListProductsAdminRequest, opts ...grpc.CallOption) (*ListProductsAdminResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListProductsAdminResponse)
	err := c.cc.Invoke(ctx, ProductService_ListProductsAdmin_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProductServiceServer interface {
	...
	ListProductsAdmin(context.Context, *ListProductsAdminRequest) (*ListProductsAdminResponse, error)
...
func (UnimplementedProductServiceServer) ListProductsAdmin(context.Context, *ListProductsAdminRequest) (*ListProductsAdminResponse, error) {
...
func _ProductService_ListProductsAdmin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListProductsAdminRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProductServiceServer).ListProductsAdmin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProductService_ListProductsAdmin_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).ListProductsAdmin(ctx, req.(*ListProductsAdminRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProductService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ProductService_ListProductsAdmin_Handler,
		},
	},
